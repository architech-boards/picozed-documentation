...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="opkg_rst-board-229" class="language-markup">src/gz picozed-zynq7 http://192.168.0.100:8000/picozed-ipk/picozed-zynq7</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
