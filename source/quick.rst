...
.. note::
 ...
 | 
 | sudo cp -r /home/architech/architech_sdk/architech/picozed/toolchain/sysroots/cortexa9-vfp-neon-poky-linux-gnueabi/* /home/architech/architech_sdk/architech/picozed/sysroot


1. Return to the **Splashscreen**, which we left on Picozed board screen, and click on *Develop with Eclipse*.
...
then the ethernet connection is ok. Enable the remote debug with Yocto by typing this command on Picozed console:
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="quick_rst-host-143" class="language-markup">/home/architech/architech_sdk/architech/picozed/toolchain/sysroots/i686-pokysdk-linux/usr/bin/arm-poky-linux-gnueabi/arm-poky-linux-gnueabi-gdb</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="quick_rst-host-144" class="language-markup">/home/architech/architech_sdk/architech/picozed/sysroot/lib
