...
Furthermore, on the board there is a set of switches related to the boot process. Verify Picozed
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-181" class="language-markup">/home/architech/architech_sdk/architech/picozed/yocto/build/tmp/deploy/images/picozed-zynq7/uImage</code></pre>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-183" class="language-markup">/home/architech/architech_sdk/architech/picozed/yocto/build/tmp/deploy/images/picozed-zynq7/</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
*<image>*-picozed-zynq7.tar.gz.
*<image>* is the recipe name used to build your image, for example: core-image-minimal-dev, so that
the rootfs tarball name would be core-image-minimal-dev-picozed-zynq7.tar.gz.
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-186" class="language-markup">/home/architech/Documents/picozed</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
...
.. raw:: html
 ...
 <pre class="line-numbers pre-replacer" data-start="1"><code id="boot_rst-host-187" class="language-markup">cp /home/architech/Documents/picozed/BOOT.BIN /media/boot/
 cp /home/architech/Documents/picozed/uEnv.txt /media/boot/
 cp /home/architech/Documents/picozed/devicetree.dtb /media/boot/
...
.. raw:: html
 ...
 sudo tar -xzf /home/architech/architech_sdk/architech/picozed/yocto/build/tmp/deploy/images/picozed-zynq7/&lt;image&gt;-picozed-zynq7.tar.gz -C /media/rootfs/</code></pre>
 <script src="_static/prism.js"></script>
 <script src="_static/select_text.js"></script>
 </div>
